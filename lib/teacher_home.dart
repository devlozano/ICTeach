...
class TeacherHomePage extends StatelessWidget {
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          bottomNavigationBar: const _TeacherBottomNavBar(),
        );
      },
    );
  }
  ...
  String _teacherName(Map<String, dynamic>? profile, User user) {
    ...
    final separatedName = [
      firstName,
      if (middleName.isNotEmpty) '${middleName.characters.first.toUpperCase()}.',
      lastName,
...
class _TeacherSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: [
          _SummaryItem(label: 'Classes', value: '3'),
          _SummaryDivider(),
          _SummaryItem(label: 'Students', value: '42'),
          _SummaryDivider(),
          _SummaryItem(label: 'Pending', value: '8'),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        ...
        children: [
          _TeacherNavItem(label: 'Home', icon: Icons.home_outlined, selected: true),
          _TeacherNavItem(label: 'Classes', icon: Icons.groups_outlined),
          _TeacherNavItem(label: 'Tasks', icon: Icons.assignment_outlined),
          _TeacherNavItem(label: 'Progress', icon: Icons.bar_chart_rounded),
          _TeacherNavItem(label: 'Profile', icon: Icons.person_outline_rounded),
        ],
      ),
    );
  }
